...
#ifdef ENABLE_EEPROM_MEMORY
  this->ee->writeBlock((uint16_t)(slot * sizeof(Settings)), (uint8_t *)settings, sizeof(Settings));
#else
...
#ifdef ENABLE_EEPROM_MEMORY
  this->ee->readBlock((uint16_t)(slot * sizeof(Settings)), (uint8_t *)settings, sizeof(Settings));
#else
